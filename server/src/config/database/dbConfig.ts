...
const seedPermission = async () => {
    ...
    await PermissionModel.create({ action: "read", subject: "User", role_id: 2, condition: '{ "id": ${id} }' })
    await PermissionModel.create({ action: "update", subject: "User", role_id: 2, condition: '{ "id": ${id} }' })
    await PermissionModel.create({ action: "delete", subject: "User", role_id: 2, condition: '{ "id": ${id} }' })
    await PermissionModel.create({ action: "manage", subject: "Cart", role_id: 2, condition: '{ "id": ${id} }' })
    await PermissionModel.create({ action: "create", subject: "Order", role_id: 2 })
    await PermissionModel.create({ action: "read", subject: "Order", role_id: 2, condition: '{ "user_id": ${id} }' })
    await PermissionModel.create({ action: "delete", subject: "Order", role_id: 2, condition: '{ "payment": { "user_id": ${id} } }' })
